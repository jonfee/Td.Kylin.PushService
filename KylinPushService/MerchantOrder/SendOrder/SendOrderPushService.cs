...
namespace KylinPushService.MerchantOrder.SendOrder
{
    ...
    /// 上门预约订单被接单推送服务
    /// </summary>
    public class SendOrderPushService : BaseMerchantOrderService
    {
        /// <summary>
        /// 执行
        /// </summary>
        public override void Execute()
        {
            while (true)
            {
                try
                {
                    ...
                    SendOrderContent content = RedisDB.ListLeftPop<SendOrderContent>(MerchantOrderConfig.RedisKey.SendMerchantOrder);
